...
class App {
    ...
    async generateAudio(model) {
        ...
        try {
            ...
            this.showStatus(statusElement, 'Generating audio...', 'info');

            // Get parameters based on model
            const params = this.getModelParams(model);

            // Generate audio
            const result = await this.modelAPIs.generateAudio(model, params);
            ...
            if (result.success) {
                ...
                this.showStatus(statusElement, 'Audio generated successfully!', 'success');
            } else {
